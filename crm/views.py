...
def terms(request):
    return render(request, 'crm/terms.html')

def privpolicy(request):
    return render(request, 'crm/privpolicy.html')

def aboutloggedin(request):
    return render(request, 'crm/aboutloggedin.html')

def contactloggedin(request):
    return render(request, 'crm/contactloggedin.html')
