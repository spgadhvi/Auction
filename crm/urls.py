...
urlpatterns = [
    ...
    path('aboutloggedin', views.aboutloggedin, name='aboutloggedin'),
    path('contact_us',views.contact_us,name='contact_us'),
    path('contactloggedin',views.contactloggedin,name='contactloggedin'),
    ...
    path('privpolicy', views.privpolicy, name='privpolicy'),
